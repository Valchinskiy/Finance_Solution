  ...
  Widget build(BuildContext context) {
    return Scaffold(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        ...
                        style: const TextStyle(
                          color: Colors.white, // Белый шрифт
                          fontSize: 16,
                        ),
                      ),
                    ),
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: ColorsApplication.backColor_1,
        onPressed: () async {
          // Открываем модальное окно для добавления новой траты или пополнения
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: itemAmount.isEmpty || itemName.isEmpty
                      ...
                      : () {
                          setState(() {
                            widget.spendings.add('Трата: $itemName - $itemAmount');
                          });
            ...
            const SizedBox(height: 10), // Дополнительный отступ
          ],
        ),
      ),
    );
